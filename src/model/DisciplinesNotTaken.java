...
public class DisciplinesNotTaken {
	...
	private void insertDisciplines() {
		...
		disciplinesNotTaken.add(ine5425);
		...
		disciplinesNotTaken.add(ine5432);
		...
		disciplinesNotTaken.add(ine5433);
		...
		disciplinesNotTaken.add(ine5434);
	}
	
	/* Retorna o conjunto de disciplinas ainda não cursadas. */
	public HashSet<Object> getDisciplinesNotTakenSet() {
		return disciplinesNotTaken;
	}
